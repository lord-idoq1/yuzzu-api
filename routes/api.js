...
router.get('/randomquote', async (req, res, next) => {
	...
	if(apikeyInput != 'Yuzzu') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Idoganz/database-api/main/fun/quote.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/caklontong', async (req, res, next) => {
	...
	if(apikeyInput != 'Yuzzu') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Idoganz/database-api/main/fun/caklontong.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/tebakgambar', async (req, res, next) => {
	...
	if(apikeyInput != 'Yuzzu') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Idoganz/database-api/main/fun/tebakgambar.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/tebaklirik', async (req, res, next) => {
	...
	if(apikeyInput != 'Yuzzu') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/lord-idoq1/spam/main/kuis/tebaklirik.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/tebakkimia', async (req, res, next) => {
	...
	if(apikeyInput != 'Yuzzu') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/lord-idoq1/spam/main/kuis/tebakkimia.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/tebakbendera', async (req, res, next) => {
	...
	if(apikeyInput != 'Yuzzu') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/lord-idoq1/spam/main/kuis/tebakbendera.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/tebakjenaka', async (req, res, next) => {
	...
	if(apikeyInput != 'Yuzzu') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/lord-idoq1/spam/main/kuis/tebakjenaka.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/tebakchara', async (req, res, next) => {
	...
	if(apikeyInput != 'Yuzzu') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/lord-idoq1/spam/main/kuis/tebakchara.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/family100', async (req, res, next) => {
	...
	if(apikeyInput != 'Yuzzu') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/lord-idoq1/spam/main/kuis/family.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/darkjokes', async (req, res, next) => {
	...
	if (apikeyInput != 'Yuzzu')  return res.json(invalidKeynya)
       fetch(encodeURI(`https://raw.githubusercontent.com/Idoganz/database-api/main/meme/darkjokes.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
